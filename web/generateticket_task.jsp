...
<body>
    ...
    <div class="container-fluid">
        ...
        <form class="text-center border border-light p-5" method="post" action="confirmticket.jsp">
            ...
            <input type="text" id="date_time" name="date_time"  class="form-control mb-4" value="<%= (new java.util.Date()).toLocaleString()%>">
